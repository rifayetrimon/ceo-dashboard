// app/unlock/page.tsx (or wherever your unlock page is)
'use client';
...
const BoxedLockScreen = () => {
    ...
    // Try to get profile from your hook first
    const { data } = useProfile();

    // Fallback to session data if profile not available
    const sessionData = getSessionData();
    const username = data?.name || sessionData.username || 'User';
